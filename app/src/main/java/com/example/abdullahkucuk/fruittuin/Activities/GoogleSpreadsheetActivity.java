...
//public class GoogleSpreadsheetActivity extends AppCompatActivity {
//
//    @Override
...
public class GoogleSpreadsheetActivity extends AppCompatActivity
    ...
    void showGooglePlayServicesAvailabilityErrorDialog(
        ...
        Dialog dialog = apiAvailability.getErrorDialog(
                GoogleSpreadsheetActivity.this,
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi() throws IOException {
            String spreadsheetId = "1vpHqGzJ9YiL5gDuQd6UZCHmnv4qJfxLzlgHp3jZXblw";
            String range = "Statistieken!A2:E4";
            ...
            writeValues.add(data1);

            String range2 = "Statistieken!A3:E4";
            ...
            UpdateValuesResponse response2 = this.mService.spreadsheets().values().update(spreadsheetId, range2, valueRange)
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            GoogleSpreadsheetActivity.REQUEST_AUTHORIZATION);
                } else {
